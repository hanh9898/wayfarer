#!/usr/bin/env python3
"""appraise.py — rút thử chữ khỏi một cuốn sách và trả về CHỈ số liệu giám định.
...
def main():
    if len(sys.argv) != 2:
        emit("missing_argument", 1, message="Dùng: appraise.py <đường-dẫn-sách>")
