...
Chạy từ gốc repo `wayfarer`. Cả hai lệnh cho cùng một file.

**PowerShell (Windows):**

```powershell
New-Item -ItemType Directory -Force tests/fixtures/sample-books | Out-Null
Invoke-WebRequest -Uri "https://www.gutenberg.org/cache/epub/132/pg132.epub" -OutFile "tests/fixtures/sample-books/art-of-war.epub"
```

**bash (Linux/macOS/Git Bash):**

```bash
mkdir -p tests/fixtures/sample-books
curl -sL -o tests/fixtures/sample-books/art-of-war.epub "https://www.gutenberg.org/cache/epub/132/pg132.epub"
```

## Kiểm đã lấy đúng chưa

```bash
file tests/fixtures/sample-books/art-of-war.epub   # phải in "EPUB document"
```
