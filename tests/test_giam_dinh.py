"""Regression test cho bin/giam-dinh.py.
...
Test cần một file sách thật. Lấy về theo công thức ở tests/fixtures/sach-thu/README.md;
...
SCRIPT = REPO / "bin" / "giam-dinh.py"
SACH = REPO / "tests" / "fixtures" / "sach-thu" / "art-of-war.epub"

can_sach = pytest.mark.skipif(
    not SACH.is_file(),
    reason="chưa lấy sách thử — xem tests/fixtures/sach-thu/README.md",
)
