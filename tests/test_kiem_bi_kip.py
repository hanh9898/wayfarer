"""Regression test cho kiem-bi-kip.py.
...
SCRIPT = REPO / "bin" / "kiem-bi-kip.py"
...
def test_mang_rong_khong_phai_thieu_truong():
    ...
    """
    loi, _ = ma_loi(FIX / "kiem-thu-dac-ta")
...
def test_sai_lam_rong_chi_la_canh_bao():
    ...
    _, canh_bao = ma_loi(FIX / "tan-quyen-mau")
